...
namespace ediri.Akp
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/dirien/pulumi-akp";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("ediri.Akp.version.txt");
    ...
    internal sealed class AkpResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AkpResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
